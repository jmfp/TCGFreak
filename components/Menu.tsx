...
export default function Menu(props: {user:User | null}) {
  const router = useRouter()
  return (
    <View className='z-50 h-36 w-full flex flex-row border-t-2 border-green-600 bg-slate-950 justify-evenly'>
