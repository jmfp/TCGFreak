  ...
  return (
    <ScrollView className="bg-slate-800 size-full" style={{flex: 1}}>
        <View className="flex flex-col h-[850px] w-full">
            ...
            <View className="max-sm:h-[685px] md:h-[900px] lg:h-[1200px] w-full m-auto top-0">
                ...
                <Text className='text-white m-auto text-2xl p-2'>Average Sale Price: {cards[0].cardmarket.prices.avg1}</Text>
                 {cards[0].attacks ? 
                 ...
                 : null}
                {cards[0].abilities? <Text className='text-white m-auto text-2xl text-center my-8 p-2'><Text className="text-purple-400">Ability - {cards[0].abilities[0].name} -</Text> {cards[0].abilities[0].text}</Text> : null}
